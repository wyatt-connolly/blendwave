      ...
      <div className='relative isolate h-full overflow-hidden pt-14'>
        ...
        <div className='mx-auto max-w-2xl py-32 px-4 sm:py-48 md:px-6 lg:py-56 xl:px-8'>
          ...
          <div className='text-center'>
            ...
            Why settle for ordinary coffee when you can experience the perfect blend? Indulge in our crafted coffees today and discover a whole new world of coffee flavors!
            </p>
